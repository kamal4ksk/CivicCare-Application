...
/**
 * Component 127 - Admin Create Community Modal
 *
 * Props:
 *  - isOpen: boolean
 *  - onClose: () => void
 *  - onSubmit: (community) => void
 *      community: { name, description, emoji, cover, category, location, isPrivate }
 */
export function AdminCreateCommunityModal({ isOpen, onClose, onSubmit }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit({ name, description, emoji, cover, category, location, isPrivate });
    reset();
    onClose();
  };
...
export default AdminCreateCommunityModal;
